    ...
    <div>
      <div className="container mt-5 clients">
        <button className="btn btn-warning">
          <span className="dance-font p-2" style={{ fontSize: "20px" }}>
            <b>Clients Love</b>
          </span>
        </button>
      ...
      <div className="container">
        <div
          ...
          class="carousel slide mt-2 clients-carosel p-5"
        >
          <div class="carousel-indicators mt-2">
            <button
              className="bottom-btn bg-dark"
              type="button"
              ...
              <div className="row">
                <div className="col-4">
                  <p>
                    ...
                    Voluptatem aliquid eligendi odit qui, nihil eaque reiciendis
                    distinctio corrupti veniam incidunt!
                  </p>
